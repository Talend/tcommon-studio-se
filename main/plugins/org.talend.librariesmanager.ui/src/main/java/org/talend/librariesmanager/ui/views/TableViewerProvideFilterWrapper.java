...
/**
 * A TableViewer wrapper use to wrap an exist TableViewer, and provider a text field to filter item with displayed labels.
 * It has a fixed time {@value #DELAY_TO_FILTER_TIME} to delay the filter action when user keep typing the content.
 * It will immediately do filter action when user typed CR keys.
 *
 * @author GaoZone
 * @version 0.1
 */
