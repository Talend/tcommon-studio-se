...
public class ChooseWorkspaceDialog extends TitleAreaDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        setTitle(Messages.getString("WorkspaceDlg.title")); //$NON-NLS-1$
        setMessage(Messages.getString("WorkspaceDlg.Message")); //$NON-NLS-1$
    ...
    protected void configureShell(Shell shell) {
        ...
        shell.setText(Messages.getString("WorkspaceDlg.title")); //$NON-NLS-1$
    }
