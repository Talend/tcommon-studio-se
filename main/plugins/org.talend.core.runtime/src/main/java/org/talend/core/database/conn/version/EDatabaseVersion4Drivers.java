...
public enum EDatabaseVersion4Drivers {
    ...
    // add for 9594
    MSSQL(new DbVersion4Drivers(EDatabaseTypeName.MSSQL,"Open source JTDS", "JTDS", "jtds-1.3.1-patch-20190522.jar")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    MSSQL_2012(new DbVersion4Drivers(EDatabaseTypeName.MSSQL,
            "Microsoft SQL Server 2012", "Microsoft SQL Server 2012", "jtds-1.3.1-patch-20190522.jar")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
