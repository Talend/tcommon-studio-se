...
public class ConnParameterKeys {
    ...
    public static final String CONN_PARA_KEY_MAPRDB_SET_ZNODE_PARENT = "CONN_PARA_KEY_MAPRDB_SET_ZNODE_PARENT"; //$NON-NLS-1$

    public static final String CONN_PARA_KEY_MAPRDB_ZNODE_PARENT = "CONN_PARA_KEY_MAPRDB_ZNODE_PARENT"; //$NON-NLS-1$
