...
public class TreeLayout extends AbstractLayout {
    ...
    public void layout(IFigure container) {
        ...
        for (int i = 0; i < subtrees.size(); i++) {
            ...
            /*
             * In some cases, the current child may extend beyond the left edge of the container because of the way it
             * overlaps with the previous child. When this happens, shift all children right.
             */
            ...
            /*
             * In some cases, the current child "i" only touches the contour of a distant sibling "i-n", where n>1. This
             * means that there is extra space that can be distributed among the intermediate siblings
             */
