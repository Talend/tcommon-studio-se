...
public class LabelledDirectoryField {
     ...
     */
    public LabelledDirectoryField(Composite composite, String string) {
        createFileField(composite, string, null, 1, DEFAULT_FIELD_STYLE, true);
    }
     ...
     * @param isFill
     */
    public LabelledDirectoryField(Composite composite, String string, String[] extensions, boolean isFill) {
    ...
    protected void displayDialog(Composite composite, String[] extensions) {
        DirectoryDialog fileDialog = new DirectoryDialog(composite.getShell(), SWT.OPEN);
