...
public class ParameterValueUtilTest {
    ...
    public void testMixedEncryptDecryptFunction1() throws Exception {
        ...
        String decryptPassword2 = StudioEncryption.decrypt("+ZE8yV1ehYi0jSmx94/wVA==");
        ...
        decryptPassword2 = StudioEncryption.decrypt("+ZE8yV1ehYi0jSmx94/wVA==");
        Assert.assertEquals("pr", decryptPassword1);
        Assert.assertEquals("EL3F4nt3", decryptPassword2);
    }
    ...
    public void testMixedEncryptDecryptFunction2() throws Exception {
        ...
        String encryptPassword2 = StudioEncryption.encrypt("123");
        Assert.assertEquals("123", PasswordEncryptUtil.decryptPassword(encryptPassword1));
        Assert.assertEquals("123", StudioEncryption.decrypt(encryptPassword2));

        // redo again.
        encryptPassword1 = PasswordEncryptUtil.encryptPassword("123");
        encryptPassword2 = StudioEncryption.encrypt("123");
        Assert.assertEquals("123", PasswordEncryptUtil.decryptPassword(encryptPassword1));
        Assert.assertEquals("123", StudioEncryption.decrypt(encryptPassword2));
    ...
    public void testMixedEncryptDecryptFunction3() throws Exception {
        ...
        String decryptValue2 = StudioEncryption.decrypt("HiV5kR+6mPKhnI5NbYbw/Q==");
        String decryptValue3 = StudioEncryption.decrypt("+ZE8yV1ehYi0jSmx94/wVA==");
        ...
        decryptValue2 = StudioEncryption.decrypt("HiV5kR+6mPKhnI5NbYbw/Q==");
        decryptValue3 = StudioEncryption.decrypt("+ZE8yV1ehYi0jSmx94/wVA==");
        Assert.assertEquals("pr", decryptValue1);
        Assert.assertEquals("aiXea2Va", decryptValue2);
        Assert.assertEquals("EL3F4nt3", decryptValue3);
    ...
    public void testTDI30227_MultiThread1() {
        ...
        Thread t2 = new Thread() {
            ...
            public void run() {
                ...
                String decryptValue2 = StudioEncryption.decrypt(testEncryptionValue2);
    ...
    public void testTDI30227_NewDecryption4OldValue1() {
        String decryptValue1 = StudioEncryption.decrypt("dxlWbpCxXBw="); // use new encryption to decrypt old
                                                                                  // one.
    ...
    public void testTDI30227_NewDecryption4OldValue3() {
        ...
        String decryptValue2 = StudioEncryption.decrypt("+ZE8yV1ehYi0jSmx94/wVA==");
        ...
        // redo
        decryptValue2 = StudioEncryption.decrypt("+ZE8yV1ehYi0jSmx94/wVA==");
    ...
    public void testTDI30227_OldDecryption4NewValue1() {
        ...
        String decryptValue3 = StudioEncryption.decrypt("HiV5kR+6mPKhnI5NbYbw/Q==");
