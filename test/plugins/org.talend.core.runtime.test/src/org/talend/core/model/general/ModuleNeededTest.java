...
public class ModuleNeededTest {
    ...
    public void testGetStatus1() throws URISyntaxException, IOException {
        ...
        String mavenURI = "mvn:org.apache.hadoop/hadoop-core/1.2.1/jar";
        String customURI = "mvn:org.apache.hadoop/hadoop-core/1.2.1/jar";
        String platformURL = "platform:/plugin/org.talend.libraries.hadoop/lib/hadoop-core-1.2.1.jar";
        ILibraryManagerService libService = GlobalServiceRegister.getDefault().getService(
                ILibraryManagerService.class);
        ModuleNeeded module1 = new ModuleNeeded("", "hadoop-core-1.2.1.jar", "description", false, null, null,
                mavenURI);
